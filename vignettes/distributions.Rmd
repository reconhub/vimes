...
vignette: >
  ...
  %\VignetteIndexEntry{Expected distributions of pairwise distances.}
...
knitr::opts_chunk$set(fig.width=7, fig.height=7, fig.path="figs/dist_")
options(digits = 4)
```

Expected distributions of pairwise distances
============================================
